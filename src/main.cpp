...
std::vector<glm::vec3> commands_to_vertices(std::vector<gcode::command> const & commands);
...
int main(int argc, char *argv[])
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        auto projection_matrix = glm::perspective(glm::radians(45.0f), (float) window_parameters.width / (float) window_parameters.height, 1.0f, 100.0f);
